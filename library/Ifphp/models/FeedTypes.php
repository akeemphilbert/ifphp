 ...
 * with the FeedTypes interaction with the Feedtypes Table or anything
...
/**
 * This class contains all the db interactions for the FeedType
 */
class FeedTypess extends AbstractModel{
	protected $_name = 'feedTypes';
